...
export const Register = () => {
  ...
  const { user, regError, loading } = useSelector((state) => state.auth);
  ...
  useEffect(() => {
    ...
    if (regError) {
      setErrorMessage(regError);
      dispatch(clearError());
    }
  }, [user, regError, navigate, dispatch]);
    ...
    <div className="flex flex-col w-full h-full bg-gradient-to-r from-[#809bae] to-[#bed7e2] place-items-center justify-center">
      ...
      >
        ...
        <div className="place-content-center">
          <h1 className="text-center font-semibold mb-4">Create account</h1>
          <form
